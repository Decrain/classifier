...
/**
 * Created by Decrain on 2017/7/28.
 */
 ...
 *
 */
public class GbkChange {
    public static final String CLASS_PATH = FileUtils.getClassPath();

    public static final String DirName = CLASS_PATH+"/data/ceshi/C39-Sports";

    public static void main(String[] args) {
        // 需要转换的文件目录
        String fromPath =DirName;
        // 转换到指定的文件目录
        String toPath = DirName;
