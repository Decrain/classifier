 ...
 */
public class CHNdataResult {

    public static void CHNdataResultUtil() {
        ...
        DBCollection collection1 = db.getCollection("CHNdataResult");
       ...
       * */
        ...
        System.out.println("==========================大陆地区统计结果输出=========================");
        System.out.println("总数： " + CHNQuantity);
        System.out.println("==========================大陆类别数统计结果输出=========================");
