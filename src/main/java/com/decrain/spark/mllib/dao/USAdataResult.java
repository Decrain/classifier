 ...
 */
public class USAdataResult {
    public static void USAdataResultUtil() {
        ...
        DBCollection collection1 = db.getCollection("USAdataResult");
       ...
       * */
        ...
        System.out.println("==========================美国地区统计结果输出=========================");
        System.out.println("总数： "+count);

        if(count ==0){
            count += 1;
        }
        System.out.println("==========================美国类别数统计结果输出=========================");
        ...
        System.out.println("政治类类数据所占数量及比例： " + "数量: " + CarQuantity + "   比例： " + df.format((double) 100 * CarQuantity / count) + "%");
