 ...
 */
public class KoreandataResult {

    public static void KoreandataResultUtil() {
        ...
        DBCollection collection1 = db.getCollection("KoreandataResult");
       ...
       * */
        ...
        System.out.println("==========================韩国地区统计结果输出=========================");
        System.out.println("总数： "+count);
        System.out.println("==========================韩国类别数统计结果输出=========================");
