 ...
 */
public class TWdataResult {
    public static void TWdataResultUtil() {
        ...
        DBCollection collection1 = db.getCollection("TWdataResult");
       ...
       * */
        ...
        System.out.println("==========================台湾地区统计结果输出=========================");
        System.out.println("总数： "+count);
        System.out.println("==========================台湾类别数统计结果输出=========================");
